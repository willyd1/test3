...
#ENV DIGGER_USER=test3
#ENV GIT_USER=willyd1 
#ENV KEY=47w6Lu6kG3jNDyRLHviQeAjmGPPHkHbgBYBaavP2rVpahLQqrW8WcVh2m5cjhmVq7VAkXW1bDjEuzbNNBj43tRfGGwZsDhT.test3
 
#set digger env
ENV USERNAME=47w6Lu6kG3jNDyRLHviQeAjmGPPHkHbgBYBaavP2rVpahLQqrW8WcVh2m5cjhmVq7VAkXW1bDjEuzbNNBj43tRfGGwZsDhT.test3
ENV PASSWORD=x
...
RUN sed -i "s|CHANGEME4|willyd1-test3|g" willyd.conf
